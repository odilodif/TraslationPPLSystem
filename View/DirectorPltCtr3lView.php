...
<script src="./View/js/DirectorPlantCtrl1/directorPlantCtrl3.js" type="text/javascript"></script>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#list-to-executed">Por Finalizar</a></li>                            
                            <li><a href="#executed">Historial Finalizados</a></li>                            

                        </ul>
                    </div>
                    <div class="tab-content">
                        <div id="list-to-executed" class="tab-pane fade in active">
                                ...
                                <div class="box-body">
                                    <div class="">
                                        <div class="mailbox-controls">
                                            ...
                                            <button type="button" class="btn btn-warning btn-xs" name="button" id="btn-aprobed-all" onclick="btnExecute()">Finalizar</button>
                                            <?php echo "" . $_SESSION['_USU'][0]['menu_description_description'] ?>
                                        </div>
                                        <div class="table-responsive mailbox-messages">
                                            <div class="table-responsive mailbox-messages">

                                                <table id="tbl_to_execute" class="table table-striped table-bordered table table-hover" style="width:100%">
                        ...
                        <div id="approved" class="tab-pane fade">
                            ...
                            <p>Lista de Traslados Aprobados por el Director de Régimen Cerrado</p>
                        ...
                        <div id="authorized" class="tab-pane fade">
                            ...
                            <p>Lista de Traslados Autorizados por el Subdirector Técnico de Rehabilitación Social</p>
                        ...
                        <div id="executed" class="tab-pane fade">
                            ...
                            <p>Historial de Traslados  Finalizados por el Director Técnico de <b>Operativos</b>, Logística, Equipamiento e Infraestructura.</p>
