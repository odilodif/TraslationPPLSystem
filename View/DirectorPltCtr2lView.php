                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#to_autorize">Por Autorizar</a></li>                            
                    ...
                    <div class="tab-content">
                        <div id="to_autorize" class="tab-pane fade in active">
                                ...
                                <div class="box-body">
                                    <div class="">
                                        <div class="mailbox-controls">
                                            ...
                                            <button type="button" class="btn btn-warning btn-xs" name="button" id="btn-aprobed-all" onclick="btnAhtorize()">Autorizar</button>
                                            <span id="id_DirectionParent" style="color:white;"></span><span id="directionParentDesc"></span>
                                        </div>
                                        <div class="table-responsive mailbox-messages">
                                            <div class="table-responsive mailbox-messages">

                                                <table id="tbl_to_authorize" class="table table-striped table-bordered table table-hover" style="width:100%">
                            ...
                            <form id="fmrEditTraslationAnalyst">
                                <div class="modal-body">
                                    ...
                                    <div class="grid-container">
                                        ...
                                        <div class="item2">
                                            <div>
                                                <input type="text" id="CplSource" value="" readonly="" style="width:250px">
                                            </div>
                                        </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-outline" onclick="saveCommentary();" disabled >Guardar</button>
                                </div>
                            </form>
                        </div>
                        <!-- /.modal-content -->
