...
<div style="float:right">
    <input type="submit" id="btnTransfSentencedPPL" class="btn-primary" value="Enviar" style="margin-right: 1135px;"/> Buscar: <input type="text" style=" margin: 10px "> 
</div>
...
<div id="content_ficha_ppl" class="container_global">
    <div id="content_data_ppl" class="contents">
        <table>           
            ...
            <tr><td>Cédula </td><td>: 1713656120  &nbsp; &nbsp; &nbsp; Verificado: <input type="checkbox" id="checked" checked="checked"  disabled /></td></tr>
            <tr><td>Delito Cometido</td><td>: ART. 379\LESIONES CAUSADAS POR ACCIDENTE DE TRANSITO</td></tr>             
            ...
            <tr><td>PENA IMPUESTA</td><td>: 5 años </td></tr>
            <tr><td>Estado de la Cuasa </td><td>: Procesado</td></tr> 
    ...
    <div id="content_data_ppl_dos" class="contents">
         <table>
              <tr><td>Tiempo de Permanencia en el centro </td><td> Años<input type="number" id="tentacles" name="tentacles"
       min="0" max="100"> Meses<input type="number" id="tentacles" name="tentacles"
       min="0" max="12"> Días <input type="number" id="tentacles" name="tentacles"
       min="0" max="31"> </td></tr>
            <tr><td>Información de Traslado</td><td></td></tr>
             <tr><td>Situación Jurídica de la PPL </td><td>: Regimen Semi Abierto</td></tr>
