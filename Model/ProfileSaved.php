...
//Methods
    ...
    public function readByUser($idUser) {
        $info;
        try {
            $query = "SELECT prfl_saved_id,usr_id,menu_description_id,prfl_saved_state from profile_saved "
                    . "WHERE usr_id=(SELECT usr_id from user_login  WHERE usr_id_sgp= $idUser)  and prfl_saved_state = 't';";
            //echo '' . $query;            
